defmodule PetacularWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PetacularWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PetacularWeb.Gettext, "errors", msg, opts)
    end
  end
